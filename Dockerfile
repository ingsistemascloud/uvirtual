...
RUN wget https://raw.githubusercontent.com/carlos22ivan/moodle-docker/master/config/httpd.conf

RUN mv httpd.conf /etc/httpd/conf/

RUN wget https://raw.githubusercontent.com/carlos22ivan/moodle-docker/master/config/start.sh
